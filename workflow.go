...
type ActionResponse struct {
	...
	Conditions ActionCondition `json:"station.action.conditions" jsonschema:"title=Conditions,description=Conditions for the action,default={}" jsonschema_extras:"mode=edit"`
